...
if ($hook_event == 'redcap_data_entry_form' ) {
    ...
    include_once HOOK_PATH_RESOURCES . "colcount.php";
...
if ($hook_event == 'redcap_project_home_page') {
    ...
    include_once HOOK_PATH_RESOURCES . "hide_home_page_dashboard.php";
}
...
// YOU SHOULD COMMENT THIS OUT ONCE YOU ARE SURE IT IS WORKING:
