...
/**
 * This hook relies on the fact that key field you put in the redcap_config table will be present as a global variable.
 *
 * So, we have run:
 *
 * INSERT INTO redcap_config (field_name, value) VALUES ('user_rights_template_pid', xx);
 *
 * where XX is the project id that has your global user rights roles configured.
 */
...
$msgAlign 	= "center";
$msgId 		= "actionMsg";
//	hook_log("error","ERROR");
//	hook_log("testhooklog");
...
function addApiScript($project_id){
	$username 	= 'api_script';
