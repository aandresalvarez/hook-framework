...
// Due to something I don't understand, returning the result from the array appears to be failing
// so, I'm instead waiting to return the $result until after the include statement
